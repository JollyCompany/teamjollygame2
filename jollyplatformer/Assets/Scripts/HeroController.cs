...
public class HeroController : MonoBehaviour
{
	...
	public bool Shooting
	{
		...
		{
			InputDevice inputDevice = this.InputDevice;
			return inputDevice == null ? Input.GetButton ("Fire3") : inputDevice.Action3.WasPressed;
		}
	}
	...
	public bool GetBiggerStart
	{
		...
		{
			InputDevice inputDevice = this.InputDevice;
			return inputDevice == null ? Input.GetButtonDown ("Fire2") : inputDevice.Action2.WasPressed;
		}
	}
	...
	public bool GetBiggerHold
	{
		...
		{
			InputDevice inputDevice = this.InputDevice;
			return inputDevice == null ? Input.GetButton ("Fire2") : inputDevice.Action2.IsPressed;
		}
	}
	...
	public bool GetBiggerEnd
	{
		...
		{
			InputDevice inputDevice = this.InputDevice;
			return inputDevice == null ? Input.GetButtonUp ("Fire2") : inputDevice.Action2.WasReleased;
		}
	}
